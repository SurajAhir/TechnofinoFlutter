...
class UpdateYourStatus extends StatefulWidget {
  UserData userData;
  UpdateYourStatus(this.userData, {Key? key}) : super(key: key);

  @override
  State<UpdateYourStatus> createState() => _UpdateYourStatusState();
}

class _UpdateYourStatusState extends State<UpdateYourStatus> {
    ...
    if (image != null) {
      ...
      if (attachmentKey.isNotEmpty) {
        ...
        await ApiClient(Dio(BaseOptions(contentType: "application/json")))
            .generateAttachmentKeyForUserProfile(
            MyDataClass.api_key,
  ...
  void postReply(BuildContext context, String message) async{
    ...
    var response = await ApiClient(
        ...
        .getResponseOfProfilePostsOfUpdateStatus(
        MyDataClass.api_key, MyDataClass.myUserId, widget.userData.user_id,message,attachmentKey);
    Navigator.pop(context);
