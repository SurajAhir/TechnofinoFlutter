...
class ExpandedReplyConversation extends StatefulWidget {
  Conversations conversation;
   ExpandedReplyConversation(this.conversation, {Key? key}) : super(key: key);

  @override
  State<ExpandedReplyConversation> createState() => _ExpandedReplyConversationState();
}

class _ExpandedReplyConversationState extends State<ExpandedReplyConversation> {
