...
class ReplyOnPostsOfThreads extends StatefulWidget {
  PostsOfThreads post;
  String receivedMessage="";
   ReplyOnPostsOfThreads(this.post, this.receivedMessage,{Key? key}) : super(key: key);

  @override
  State<ReplyOnPostsOfThreads> createState() => _ReplyOnPostsOfThreadsState();
}
...
showLoaderDialog(context,"Sending");
    ...
    var response = await ApiClient(
        ...
        MyDataClass.api_key, MyDataClass.myUserId, widget.post.thread_id,message,attachmentKey);
    Navigator.pop(context);
    Navigator.pop(context);
